...
import os
os.environ["OPENCV_AVFOUNDATION_SKIP_AUTH"] = "1"  # Necesario para macOS
    ...
    if st.session_state.cap is None:
        with st.spinner("⌛ Cargando modelo y preparando la cámara: va a tomar un minuto"):
            ...
            if not st.session_state.cap.isOpened():
                ...
                En macOS, debés dar permisos de cámara a Terminal o VSCode:
                1. Abrí **Preferencias del Sistema** → **Privacidad y Seguridad** → **Cámara**
                2. Activá el permiso para **Terminal** o la app que estés usando
